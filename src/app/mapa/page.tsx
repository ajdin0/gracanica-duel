    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 flex flex-col items-center justify-center text-center">
        <h1 className="text-3xl sm:text-4xl font-bold text-primary mb-8">
          Mapa Mjesnih Zajednica
        </h1>
        <p className="text-lg text-muted-foreground mb-6">
          Interaktivna mapa zajednica Gračanice će biti dostupna uskoro.
        </p>
        <div className="w-full max-w-3xl aspect-[16/9] relative border-2 border-dashed border-border rounded-lg overflow-hidden bg-muted/30 flex items-center justify-center">
           <Image
            ...
            alt="Placeholder mapa regije Gračanica"
            layout="fill"
            objectFit="contain"
         ...
         <p className="text-sm text-muted-foreground mt-6">
          Radimo na prikupljanju podataka za prikaz interaktivne mape.
        </p>
      </main>
      <Footer />
    </div>
